        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              />
              <span className="text-xl font-bold text-white">FitFork</span>
            </div>
            <p className="text-sm text-gray-400">
              Your personal food & health companion. Track meals, discover recipes, and achieve your wellness goals.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://app.fitfork.app" className="hover:text-green-400 transition-colors">Launch App</a></li>
            </ul>
          </div>
